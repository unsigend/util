...
{
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('m', "multi", "test multiple arguments", &str_array,
                      argparse_callback_multiple_arguments,
                      (intptr_t)&array_size),
        OPTION_END()};

    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 10,
                   (char *[]){"--string", "hello", "--int", "42", "--float",
                              "3.14", "--bool", "--multi", "arg1", "arg2"});
  ...
  }
  {
    ...
    struct argparse argparse;
    struct argparse_option options[] = {
        OPTION_STRING('s', "string", "string that will be overwritten", &str,
                      NULL, 0),
        OPTION_INT('i', "int", "integer that will be overwritten", &int_val,
                   NULL, 0),
        OPTION_END()};
    ...
    argparse_parse(
        &argparse, 6,
        (char *[]){"--string", "first", "--string", "second", "--int", "123"});
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('m', "multi", "multiple args", &multi,
                      argparse_callback_multiple_arguments,
                      (intptr_t)&array_size),
    ...
    argparse_parse(
        &argparse, 8,
        (char *[]){"-a", "short1", "--str2", "long2", "-m", "m1", "m2", "-f"});
  ...
  }
  {
    ...
    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 4, (char *[]){"--string", "", "-m", ""});
  ...
  }
  {
    ...
    struct argparse argparse;
    struct argparse_option options[] = {
        OPTION_STRING('a', "array1", "first array", &array1,
                      argparse_callback_multiple_arguments, (intptr_t)&size1),
        OPTION_STRING('b', "array2", "second array", &array2,
                      argparse_callback_multiple_arguments, (intptr_t)&size2),
        OPTION_END()};

    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 7,
                   (char *[]){"-a", "a1", "a2", "-b", "b1", "b2", "b3"});
  ...
  }
  {
    ...
    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 3, (char *[]){"-x", "--flag2", "-z"});
  ...
  }
  {
    ...
    argparse_parse(
        &argparse, 7,
        (char *[]){"--number", "42", "-d", "3.14", "-t", "hello", "-f"});
  ...
  }
  {
    ...
    argparse_parse(&argparse, 4, (char *[]){"-v", "test", "--value", "ggg"});
  ...
  }
  {
    ...
    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 6, (char *[]){"-a", "", "test", "-b", "", ""});
  ...
  {
    const char *value = NULL;
    struct argparse_description desc = {._description = "Test Program",
                                        ._epilog = "Test Epilog",
                                        ._usage = "test [options]",
                                        ._program_name = "test"};
    struct argparse argparse;
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('s', "support_arch", NULL, &support_arch,
                      argparse_callback_multiple_arguments,
                      (intptr_t)&support_arch_size),
        OPTION_STRING('p', "path", NULL, &path_list,
                      argparse_callback_multiple_arguments,
                      (intptr_t)&path_list_size),
        OPTION_STRING(0, "file", NULL, &file_name_list,
                      argparse_callback_multiple_arguments,
                      (intptr_t)&file_name_list_size),
        OPTION_BOOLEAN('d', "debug", NULL, &debug, NULL, 0),
        OPTION_BOOLEAN('v', "verbose", NULL, &verbose, NULL, 0),
        OPTION_END()};

    argparse_init(&argparse, options, NULL);
    argparse_parse(&argparse, 31,
                   (char *[]){"-f",
                              "--processor",
                              "4",
                              "-m",
