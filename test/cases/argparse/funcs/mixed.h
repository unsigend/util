...
{
  {
    ...
    argparse_parse(&argparse, 11,
                   (char *[]){"--flag2", "-s", "world", "--num1", "123", "-c",
                              "--value", "2.718", "-m", "456", "--flag1"});
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('n', "name", NULL, &name, NULL, 0), OPTION_END()};
    argparse_init(&argparse, options, NULL);

    argparse_parse(
        &argparse, 7,
        (char *[]){"-f", "--count", "-42", "-r", "-1.234", "--name", "test"});
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('o', "output", NULL, &output, NULL, 0), OPTION_END()};
    argparse_init(&argparse, options, NULL);

    argparse_parse(&argparse, 9,
                   (char *[]){"-v", "--level", "1", "-l", "2", "-o", "file1.txt",
                              "--output", "file2.txt"});
  ...
  }
  {
    ...
    argparse_parse(&argparse, 9,
                   (char *[]){"--enable", "-w", "999999", "-h", "0", "--scale",
                              "0.000001", "-f", "test@#$%"});
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_DOUBLE('r', "ratio", NULL, &ratio, NULL, 0),
        OPTION_STRING('t', "text", NULL, &text, NULL, 0), OPTION_END()};
    argparse_init(&argparse, options, NULL);

    argparse_parse(&argparse, 6,
                   (char *[]){"-v", "-42", "-r", "-3.14159", "-t", ""});
    ...
    argparse_parse(&argparse, 6,
                   (char *[]){"--value", "-2147483648", "--ratio",
                              "-1.7976931348623157e+308", "--text", ""});
  ...
  }
  {
    ...
    argparse_parse(&argparse, 8,
                   (char *[]){"--flag1", "--flag2", "--count", "-2147483648",
                              "--amount", "-2.2250738585072014e-308", "--name",
                              "\t\n\r"});
  ...
  }
  {
    ...
    struct argparse_option options[] = {
        ...
        OPTION_STRING('s', "string", NULL, &str, NULL, 0), OPTION_END()};
    argparse_init(&argparse, options, NULL);

    argparse_parse(&argparse, 7,
                   (char *[]){"-f", "-i", "2147483647", "-d",
                              "1.7976931348623157e+308", "-s", "test"});
  ...
  }
  {
    ...
    argparse_parse(
        &argparse, 6,
        (char *[]){"--double", "1.23e+5", "--int", "-0100", "--string", "test2"});
