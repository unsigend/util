...
extern int _index;
extern void simple_callback(void *data, const char *section, const char *key,
                            const char *value);
extern void complex_callback(void *data, const char *section, const char *key,
                             const char *value);
extern void complex_callback_everything(void *data, const char *section,
                                        const char *key, const char *value);

UTEST_TEST_CASE(parse_all)
{
  {
  ...
  iniparse_all(&iniparse, simple_callback, data_list);
  ...
  iniparse_all(&iniparse, complex_callback, data_list);
  ...
  EXPECT_EQUAL_STRING(data_list[17].value,
  ...
  EXPECT_EQUAL_STRING(data_list[25].value,
  ...
  iniparse_all(&iniparse, complex_callback_everything, data_list);
  ...
  EXPECT_EQUAL_STRING(data_list[current_index + 1].value,
